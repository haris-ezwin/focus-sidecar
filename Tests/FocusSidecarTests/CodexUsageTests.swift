...
struct CodexUsageTests {
    ...
    static func main() throws {
        ...
        print("Codex usage checks passed (9 accounting/parser checks; optional live connection).")
    }
    ...
    static func correctionDoesNotSubtractUsage() {
        ...
        expect(history.days[0].usedPercent == 10)
    }
    ...
    static func midnightUsesMalaysiaTime() {
        ...
        expect(history.days[1].usedPercent == 1)
